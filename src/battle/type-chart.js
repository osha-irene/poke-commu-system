...
export function getEffectivenessMessage(effectiveness) {
  if (effectiveness === 0) return '효과가 없다...';
  if (effectiveness < 0.5) return '효과가 별로인 것 같다...';
  if (effectiveness < 1) return '효과가 별로다...';
  if (effectiveness === 1) return '';
  if (effectiveness === 2) return '효과가 굉장했다!';
  if (effectiveness >= 4) return '효과가 굉장했다!!';
  return '효과가 굉장했다!';
}
