...
export default function Sidebar({
    ...
    const visibleAdventureTabs = adventureTabs.filter((item) =>
        visible(item.id)
    );

    const isTrainerActive =
        currentTab === "profile" ||
        trainerTabs.some((item) => item.id === currentTab);
    const isAdventureActive = adventureTabs.some(
                ...
                <nav className="trainer-nav" aria-label="사이드 메뉴">
                    <div className="trainer-nav__main">
                        <div className="trainer-nav__group">
                            ...
                            <div
                                className="trainer-nav__submenu"
                                aria-label="트레이너 카드 하위 메뉴"
                            >
                    ...
                    <div className="trainer-nav__bottom">
                        ...
                        >
                            {visible("qna") && (
                                ...
                                >
                                    ...
                                    {hasQnaUpdate && (
                                        <span
                                            aria-hidden="true"
                                            style={UPDATE_DOT_STYLE}
                                        />
                                    )}
                                </button>
                            )}
                            <a
                                href="https://x.com/Poke_OriginB"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="trainer-nav__social-button"
                                aria-label="Twitter"
                            >
                            ...
                            <a
                                href="https://originb-pokemon.world/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="trainer-nav__social-button"
                                aria-label="Mastodon"
